...
class Covid extends CI_Controller
{
    ...
    function excel_daftar()
    {
        $header = $this->db->list_fields('mt_pasien_covid');
        $header[0] = "No";
        //    manual header
        // $header = array("No", "asda", "asd"); // single row code
        // $header[] = "no_rm";
        // $header[] = "nama_pasien";
        // $header[] = "nama_pasien";
        // 
        $this->excelspout->export_data('Data Pasien', $header, 'id_pasien', $this->daftar->get_all_excel());
    }
    ...
    function excel_odprajal()
    {
        // $header = $this->db->list_fields('tc_daftar_pasien');
        $header[0] = "No";
        $header[] = "No RM";
        $header[] = "Nama Pasien";
        ...
        $header[] = "Umur";
        $header[] = "Jenkel";
        $header[] = "Pemeriksaan DL";
        $header[] = "Pemeriksaan Petugas Ront Thorax";
        //    manual header
        // $header = array("No", "asda", "asd"); // single row code
        // $header[] = "no_rm";
        // $header[] = "nama_pasien";
        // $header[] = "nama_pasien";
        // 
        $this->excelspout->export_data('Data Pasien ODP Rajal', $header, 'id_daftar_pasien', $this->odprajal->get_all_excel());
    }
    // Daftar Pasien Covid-19  -----------------------------------------------------------------------------------------------
