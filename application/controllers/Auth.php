                ...
                if (password_verify($password, $dd_user['password'])) {
                    ...
                    $data = [
                     ...
                     if ($dd_user['role_id'] == 1) {
                        ...
                        $this->session->set_flashdata('flash63', 'Hello.. Selamat Datang');
                         redirect('user');
                     }
                } else {
...
// }
    ...
    //     // $token = $this->input->get('token');
    //     $user = $this->db->get_where('dd_user', ['username' => $username])->row_array();
    //     if ($user) {
            
    //         if ($this->session->set_userdata('reset_email', $email));
    //             $this->changePassword();{
    //         } else {
