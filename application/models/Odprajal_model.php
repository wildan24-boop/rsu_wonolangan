...
class Odprajal_model extends CI_Model
{
    ...
    {
        $this->db->select("id_daftar_pasien,no_rm,nama_pasien,tgl_lahir,umur,jenkel,odpjal_pem_dl,odpjal_pem_petugas_thorax");
        $this->db->order_by('id_daftar_pasien', 'ASC');
        return $this->db->get('tc_daftar_pasien');
    }
}
