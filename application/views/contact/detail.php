          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <td><a href="<?= base_url ('assets/dist/img/profile/') . $detail ['name']; ?>" data-lightbox="<?= $detail['role_id']; ?>" data-title="<?= $detail['username']; ?>"> 
                  <img  src="<?= base_url('assets/dist/img/profile/') . $detail['foto']; ?>" alt="User profile picture" class="profile-user-img img-fluid img-circle"></a>
                </div>

                <h3 class="profile-username text-center"><?= $detail['name']; ?></h3>

                <p class="text-muted text-center"><?= $detail['username']; ?></p>
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b>Jabatan</b> <a class="float-right"><?= $detail['nama_jabatan']; ?></a>
                  </li>
                  <li class="list-group-item">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <p class="text-muted"><?= $detail['no_hp']; ?></p>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
