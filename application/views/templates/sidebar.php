  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-image: url('<?= base_url('assets/dist/img/sidebar.png')?>')">
    <!-- Brand Logo -->
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <a href="#" class="d-block text-success"> Online </a>
        </div>
      </div>
      <!-- Sidebar Menu -->
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <a href="#" class="nav-link active" style="background-color: #0f1c70">
            ...
            <ul class="nav nav-treeview ml-3">
               <li class="nav-item">
                <?php $sm['title'];?> 
                  <a href="<?= base_url($sm['url']);?>" class="nav-link active" style="background-color: #E6E6FA">
                  <i class="<?= $sm ['icon'];?>"></i>
                  <p><?=$sm['title'];?></p>
                </a>
              </li>
