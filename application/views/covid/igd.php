...
<section class="content">
	...
	<div class="card">
		...
		<div class="card-body">
			...
			<?php } ?>
			<button class="btn btn-default" onclick="reload_table_igd()"> Reload <i
		...
		<div class="modal fade" id="modal_igd">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<form action="" id="form_igd" class="form-horizontal" method="post"
						...
						<div class="modal-body">
                            ...
                            <label class="control-label col-md-6">Diagnosa Masuk</label>
								<div class="col-md-12">
									<textarea type="text" class="form-control" id="diagnosa_masuk"
										name="diagnosa_masuk"> </textarea>
                            ...
                            <label class="control-label col-md-6">Komorbid</label>
								<div class="col-md-12">
									<textarea type="text" class="form-control" id="komorbid"
										name="komorbid"> </textarea>
									<span class="help-block"></span>
								</div>
							</div>
				...
				<div class="modal-footer justify-content-between">
					<button type="button" id="btnSave_igd" onclick="save_igd()"
