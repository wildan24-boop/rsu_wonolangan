...
<section class="content">
	...
	<div class="card">
		...
		<div class="card-body">
			...
			<button class="btn btn-default" onclick="reload_table_odprajal()"> Reload <i class="fas fa-retweet"></i></button>
			<button class="btn btn-success" onclick="export_excel_odprajal()"> Excel </button>
		...
		<div class="modal fade" id="modal_odprajal">
			<div class="modal-dialog modal-sm">
				<div class="modal-content">
					...
					<form action="" id="form_odprajal" class="form-horizontal" method="post" enctype="multipart/form-data">
				...
				<div class="modal-footer justify-content-between">
					<button type="button" id="btnSave_odprajal" onclick="save_odprajal()" class="btn btn-primary">Save</button>
