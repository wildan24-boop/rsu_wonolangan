...
<div class="modal fade" id="modal_masuk">
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
						<input type="hidden"  id="id_tc_surat_masuk" name="id_tc_surat_masuk"/> 
  ...
  <div class="form-row">
    ...
    <div class="col">
      ...
      <input type="date" class="form-control" id="tgl_surat" name="tgl_surat" placeholder="State">
    </div>
  </div>
...
<div class="modal fade" id="modal_disposisi" role="dialog">
  ...
  <h6 class="m-0 font-weight-bold text-white" align="center"><span>  Disposisi</span></h6>
  </div>
  <div class="card-body">
  <div class="form-row">
  <?php foreach($disposisi as $dis) : ?>
    <div class="col-6">
          ...
          <div class="custom-control custom-checkbox">
              <input class="minimal-red" type="checkbox" name="id_disposisi[]" value="<?= $dis['id'] ?>"> <?= $dis['type'] ?>
      </div>
	</div>
    </div>
    <?php endforeach ?>
...
<div class="card">
  <div class="card-header bg-primary">
  <h6 class="m-0 font-weight-bold text-white" align="center"><span>Catatan</span></h6>
  </div>
  <div class="card-body">
...
<!-- // ----------------------------------------------------------------------------------------------------------- -->
      ...
      <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
						<input type="hidden" id="id_tc_surat_masuk3" name="id_tc_surat_masuk3"/> 

  <div class="form-row">
    <div class="col">
		<label class="control-label col-md-6">Tanggal Terima</label>
      <input type="date" class="form-control" id="tgl_terima" name="tgl_terima2">
    </div>
    <div class="col">
		<label class="control-label col-md-6">Tanggal Surat</label>
      <input type="date" class="form-control" id="tgl_terima" name="tgl_terima2" placeholder="State">
    </div>
  </div>
    ...
    <div class="col">
		<label class="control-label col-md-6">Nomor Surat</label>
		<input type="text" class="form-control input-sm" id="nomor" name="nomor2">
    </div>
    <div class="col">
		<label class="control-label col-md-6">Penerima Surat</label>
    <input type="text" class="form-control" id="penerima" name="penerima2" >
    </div>
  </div>
	 ...
	 <label class="control-label col-md-6">Perihal</label>
		 <div class="col-md-12">
		 <textarea type="text" class="form-control" id="hal" name="hal2"> </textarea>
		 <span class="help-block"></span>
		 </div>
	 </div>
	 ...
	 <label class="control-label col-md-6">Agenda</label>
		 <div class="col-md-12">
		 <textarea type="text" class="form-control" id="agendaris" name="agendaris2"> </textarea>
		 <span class="help-block"></span>
		 </div>
	 </div>
    ...
    <div class="col">
		<label class="control-label col-md-6">Pengirim</label>
    <input type="text" class="form-control input-sm" id="pengirim" name="pengirim2" >
			
    </div>
    <div class="col">
		<label class="control-label col-md-6">Alamat Pengirim</label>
		<input type="text" class="form-control input-sm" id="alamat_pengirim" name="alamat_pengirim2">
    </div>
  </div>
    ...
    <div class="col">
		<label class="control-label col-md-6">Kepada</label>
    <input type="text" class="form-control input-sm" id="kepada" name="kepada2">
    </div>
    <div class="col">
		<label class="control-label col-md-6">File Upload</label>
...
<div class="form-group mt-3">
  <div class="form-check">
	<label class="form-check-label" for="status" > Rahasia ? <i class="fa fa-edit ml-2"></i></label>
  <input class="form-check-input" type="checkbox" 
  value="Rahasia" name="status2" id="status" >
  </div>
</div>
...
<div class="card">
  ...
  <div class="form-group">
	 <label class="control-label col-md-6">Keterangan</label>
		 <div class="col-md-12">
		 <textarea type="text" class="form-control" id="keterangan" name="keterangan2"> </textarea>
		 <span class="help-block"></span>
		 </div>
	 </div>
   ...
   <div class="form-group mt-3">
	 <label class="control-label col-md-4">Catatan</label>
		 <div class="col-md-12">
		 <textarea type="text" class="form-control" id="komentar" name="komentar2"> </textarea>
		 <span class="help-block"></span>
		 </div>
	 </div>
   </div>
