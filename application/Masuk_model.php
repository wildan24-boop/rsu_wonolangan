...
class Masuk_model extends CI_Model {
	...
	var $order = array('tc_surat_masuk.id_tc_surat_masuk' => 'asc'); // default order 
...
{ 
    $this->db->delete('tc_surat_masuk', ['id_tc_surat_masuk' => $id]);
}
...
// Public function get_surmasuk($id)-------------------------------------------------------------------
	...
	public function get_surmasuk($id)
	{
		...
		$this->db->select('tc_surat_masuk.*,mt_client.nm_persero,mt_client.alamat_email_client,mt_client.alamat_persero');
		$this->db->from($this->table);
		$this->db->join('mt_client','tc_surat_masuk.pengirim=mt_client.id_mt_client');
		$this->db->where('id_tc_surat_masuk',$id);
		$query = $this->db->get();
